...
- [KNN vs K-means]("session4/sess4preread.html")
- 'Parts of a Figure' and 'Coding Styles' sections of [Quick Start Guide (Matplotlib)](https://matplotlib.org/stable/users/explain/quick_start.html)
### Optional: 
...
```{python}
#| code-line-numbers: "1-2|4-10|12-16|18-19"
...
(
    ...
    .fmt_number(columns =  ["Original Mean", "Original Std", "Scaled Mean", "Scaled Std"], decimals=0)
...
```{python}
#| code-line-numbers: "1-5|8-14|16-17"
