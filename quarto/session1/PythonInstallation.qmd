---
title: "Installing Software for Python Programming"
author: "Python Group"
format: 
    html:
...
This is a pre-sessoin reading that will guide you through the steps to installing Python to your computer and setting up everything else needed for starting your first python project.

By the end of this article, you will achieve the following:

-   Know what are Miniconda and the Anaconda Distribution and their relationship with Python.

-   Know what are Python virtual environments and how to use Conda to install and manage them.

-   Know what are integrated development environments (IDE) .

-   Create Quarto files and execute some Python code

#### What do I need before the session?

-   **Download the installers**–*You don't need to install them yet. This tutorial will walk you through the steps for installation.*

    ::: {.callout-tip}
    We recommend that you install software and run through the tutorial on your MSK laptop or workstation. Downloading/installing software files on VDI is extremely slow and might not install at all if the software is too large.
    :::
...
-   **Login to your GitHub Enterprise account.**
