...
Conda can be installed via installers such as Miniconda (see [▶️Follow-Along: Install Miniconda (Python + conda)](#follow-along-install-miniconda-python-conda)) or the Anaconda Distribution.
