---
title: "Software for Python Programming"
author: "Python Group"
format: 
    html:
...
Welcome!
This is a required reading for session 1 of the ***Introduction to Python*** workshop.

In this article, you can find things you need to know to get started with Python programming: How do I install Python?
What is the best way (if there is any)?
What are some useful software tools to help make coding a better experience?
This article will serve as a follow-along guide for installing the necessary programs to help you prepare for the upcoming sessions.

On the other hand, this handout will touch on some important questions–What is special about Python?
And why do we want to learn it at all as biostatisticians?
To answer these, we will first talk about the main features of Python, what it can do, and its applications in health sciences and research.
Later in the workshop, we will go more in-depth into these topics and specific features and packages/libraries through hands-on programming practices.

#### 📖Quick overview of the workshop:

**Session 1** is to help you set up everything you would need for flexible and reproducible Python projects.

**Session 2 and 3** will focus on data structure and the `pandas` library for data manipulation and .
**Session 4 will introduce you to** object-oriented programming (OOP) in Python through a demo data modeling practice.

will classes of the Python language and its applications.
Overall managing the software for , .
why we would want to that will guide you through the steps to

#### Learning objectives of this :

-   💡Know what Python is and key features of Python.
...
-   **Your computer (Windows/MacOS) to download the software**–*You will need to follow this tutorial through the steps for installing required software.*
    ...
    -   Download **Anaconda Distribution**: [Download the Anaconda Installer](https://www.anaconda.com/download/success).

    -   Download **VS Code**: [Download and install VS Code](https://code.visualstudio.com/download).

    -   Download **Quarto**: [Install from the official website](https://quarto.org/docs/get-started/).

-   **Basic GitHub knowledge & MSK GitHub Enterprise account.**

-   learn_python/LearningPython.pdf at master · lpvcpp/learn_python · GitHub

# 1 Introduction to Python

![](images/python-logo.png){width="230"}

### What is Python?

Python is a **high-level, interpreted, general-purpose programming** **language**.

Just like R, Python is open source and versatile enough to allow users perform a wide range of data analysis and computational tasks.
It is supported by a large and powerful ecosystem of external packages (libraries).
In Python, you can easily install packages with `pip` or `conda` just like you do with `install.packages()` in R.

### What can Python do?

Python is powerful and not limited to statistical analysis.
It has been widely used in areas like:
...
#### 🧬 Why Python for Biostatisticians & Bioinformaticians?
...
that blends procedural, functional,and objected-oriented paradigms.

# 2 Installating Tools 
...
Integrated features such as multi-panel layout for interactive coding, terminal, Git/GitHub connection, SSH connection.
There are many more add-on features available to be downloaded as Extensions
