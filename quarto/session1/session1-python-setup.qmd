...
-  **Open-source**: free! Mass user community contributing to the package ecosystemm
:::
...
-  **Built-in Suuport for Python and R.** No extra extensions & easy transition from VS Code and RStudio  
