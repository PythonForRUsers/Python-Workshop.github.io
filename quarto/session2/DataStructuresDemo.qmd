...
## Overview {#overview .scrollable}

- [Lists](#lists)
- [Sets](#sets)
- [Strings](#strings)
- [Dictionaries](#dicts)
- [Functions vs. Methods](#functs)
...
## Accessing Python list elements {.scrollable}
...
## Mutability of lists {.scrollable}
...
## Appending an element to a list {.scrollable}
...
## Deleting items by index {.scrollable}
...
## Deleting items by value {.scrollable}
...
## Lists vs. sets, and deleting duplicates from a list {#sets .scrollable}
...
## Shorter syntax with list comprehension {.scrollable}
...
## Mutability of Tuples {.scrollable}
...
## Functions and Tuples {.scrollable}
...
## Accessing characters in a string {.scrollable}
...
## Mutability of Strings {.scrollable}
...
## Concatenating Strings {.scrollable}
...
## f-strings (Python 3.6+) {.scrollable}
...
## Dictionary Operations {.scrollable}
...
## Adding and updating dictionary items {.scrollable}
...
## Python Dictionaries for Cancer Research Data {.scrollable}
...
## Adding and Removing Data {.scrollable}
...
## Functions vs Methods in Python {#functs .scrollable}
...
https://github.com/PythonForRUsers/Python-Workshop.github.io/tree/main/FollowAlong
