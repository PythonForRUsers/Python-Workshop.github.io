...
Check out the [blog](https://www.anaconda.com/blog/using-pip-in-a-conda-environment) for more information on using pip in a conda environment.
:::
...
![](images/vs-code-icon.png){width="120"}
...
4.  **Configure the Environment in VS Code.**
    ...
    3.  Choose the Conda python environment you created. If you don't see its name pop up, choose `Enter interpreter path...` and manually type in the location to your conda virtual environment.
